...
class Allele(object):
    '''A + B --> phenotype of this allele combination'''
...
class Chromosome(list):
    ...
    def __add__(self, other):
        'return list of phenotypes of self+other'
        l = []
        for i,(pos,allele) in enumerate(self):
            l.append(allele + other[i][1])
        return l
    
    def __mul__(self, other):
        'return homologous recombination products of self and other'
        swap = 0
...
class DiploidGenome(dict):
    ...
    e.g.
    g = DiploidGenome({1:(chr1a,chr1b), 2:(chr2a,chr2b)})'''
    def __mul__(self, other):
